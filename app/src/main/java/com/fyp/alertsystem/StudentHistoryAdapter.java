...
public class StudentHistoryAdapter
        extends RecyclerView.Adapter<StudentHistoryAdapter.VH> {
    private final List<Alert> data;
    public StudentHistoryAdapter(List<Alert> d){data=d;}

    @Override public VH onCreateViewHolder(ViewGroup p,int vt){
        View v=LayoutInflater.from(p.getContext())
                .inflate(R.layout.item_student_history,p,false);
        return new VH(v);
    }
